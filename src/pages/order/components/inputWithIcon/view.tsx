    ...
    <div className="flex flex-col space-y-1 w-full max-w-xs">
      ...
      <div className="relative">
        <input
          ...
          className="w-full pl-4 pr-10 py-2 rounded-full border border-gray-300 text-gray-600 placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-indigo-500"
        />
